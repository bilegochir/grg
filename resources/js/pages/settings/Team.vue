                ...
                <section class="grid gap-6 xl:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)]">
                    <div class="app-panel space-y-6 p-6">
                        ...
                        <form class="space-y-5" @submit.prevent="submit">
                            ...
                            <div class="flex items-center justify-between gap-4 rounded-xl border border-border/70 bg-muted/40 px-4 py-3">
                    ...
                    <div class="app-panel space-y-4 p-6">
                        ...
                        <div v-if="props.pendingInvites.length" class="space-y-3">
                            <div
                        ...
                        <div v-else class="rounded-2xl border border-dashed border-border/80 bg-muted/30 px-4 py-8 text-center">
                ...
                <section class="app-panel space-y-5 p-6">
                    ...
                    <div class="grid gap-3 md:grid-cols-2">
                        ...
                        >
                            ...
                            <p class="mt-3 text-xs text-muted-foreground">Joined {{ formatDate(member.joined_at) }}</p>
                        </div>
                    </div>
                </section>
            </div>
